...
.. note::
         If the binout file's name or extension does not include the keyword 'binout,' it will be excluded due to the filter. In this case, the user should set            the file type to 'All files (\*.\*)' and manually select the relevant file.
